...
namespace DotNetKoans.CSharp
{
	public class AboutLambdas : Koan
	{
		...
		public void BlockNotNeededOnSingleStatementLambdas()
		{
            ...
            //When you have only one statement, the curly brackets are not needed. What other two things 
            // are also missing? (A: return & the semicolon after the .ToString Method)
			Assert.Equal(lambda, anonymous);
		}
	}
}
